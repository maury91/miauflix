...
const print = (severity: Severity, service: string, message: string, ...metadata: unknown[]) => {
  ...
  switch (severity) {
    case 'debug':
      ...
      console.debug(`\x1b[34m${formattedMessage}\x1b[0m`, ...metadataFormatted);
      break;
    case 'info':
      console.log(`\x1b[32m${formattedMessage}\x1b[0m`, ...metadataFormatted);
      break;
    case 'warn':
      console.warn(`\x1b[33m${formattedMessage}\x1b[0m`, ...metadataFormatted);
      break;
    case 'error':
      console.error(`\x1b[31m${formattedMessage}\x1b[0m`, ...metadataFormatted);
      break;
  }
};
